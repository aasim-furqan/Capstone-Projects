...
st.markdown("<h1 style='text-align: center; color: #65a2ae;'>BizCardX: Extracting Business Card Data with OCR</h1>", unsafe_allow_html=True)
 

# "https://wallpaperboat.com/wp-content/uploads/2019/10/best-background-for-website-01.jpg"
# "https://wallpaperboat.com/wp-content/uploads/2019/10/best-background-for-website-05.jpg"
# "https://wallpaperboat.com/wp-content/uploads/2019/10/best-background-for-website-07.jpg"



def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://wallpaperboat.com/wp-content/uploads/2019/10/best-background-for-website-01.jpg") ;
...
selected = option_menu(None, ["Home","Upload & Extract","Modify"], 
                       ...
                       styles={"nav-link": {"font-size": "20px", "text-align": "centre", "margin": "0px", "--hover-color": "#1C61775E"},
                               "icon": {"font-size": "20px"},
                               "container" : {"max-width": "6000px"},
                               "nav-link-selected": {"background-color": "#1C6177"}})
    ...
    if uploaded_card is not None:
        ...
        def image_preview(image,res): 
            for (box,text,prob) in res :
                ...
                pt3 = box[2]
                pt4 = box[3]
                cv2.rectangle(image, pt1, pt3, (0, 255, 0),2)
                cv2.putText(image,text,(pt1[0],pt1[1]),cv2.FONT_HERSHEY_DUPLEX, 0.7, (0, 0, 0),2)
